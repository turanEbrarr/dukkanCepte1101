...
class satis_fatura_detay_rapor_page extends StatefulWidget {
  ...
  const satis_fatura_detay_rapor_page(
      {super.key,
  ...
  @override
  State<satis_fatura_detay_rapor_page> createState() =>
      _satis_fatura_detay_rapor_pageState();
}

class _satis_fatura_detay_rapor_pageState
    extends State<satis_fatura_detay_rapor_page> {
