...
class alis_fatura_detay_rapor_page extends StatefulWidget {
  ...
  const alis_fatura_detay_rapor_page(
      {super.key,
  ...
  @override
  State<alis_fatura_detay_rapor_page> createState() =>
      _alis_fatura_detay_rapor_pageState();
}

class _alis_fatura_detay_rapor_pageState
    extends State<alis_fatura_detay_rapor_page> {
                      ...
                      ElevatedButton(
                          onPressed: () async {
                            ...
                            await SharedPrefsHelper.filtreKaydet(
                                secilenKolonlar, "alisFaturaDetayRaporu");
                            ustfiltre = false;
                            setState(() {});
                          },
