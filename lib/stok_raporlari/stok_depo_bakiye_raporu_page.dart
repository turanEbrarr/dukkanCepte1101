...
class stok_depo_bakiye_rapor_page extends StatefulWidget {
  final List<List<dynamic>> gelenBakiyeRapor;
  final List<bool> gelenFiltre;
  //final String titletemp;
  const stok_depo_bakiye_rapor_page(
      {super.key, required this.gelenBakiyeRapor, required this.gelenFiltre});

  @override
  State<stok_depo_bakiye_rapor_page> createState() =>
      _stok_depo_bakiye_rapor_pageState();
}

class _stok_depo_bakiye_rapor_pageState
    extends State<stok_depo_bakiye_rapor_page> {
          ...
          Navigator.of(context).push(
            MaterialPageRoute(
                builder: (context) => cariRaporlarPdfOnizleme(
                      baslik: "Stok Depo Bakiye Raporu",
                      kolonlar: sj,
                      ...
                      ElevatedButton(
                          onPressed: () async {
                            ...
                            await SharedPrefsHelper.filtreKaydet(
                                secilenKolonlar, "raporStokDepoBakiyeFiltre");
                            ustfiltre = false;
                            setState(() {});
                          },
