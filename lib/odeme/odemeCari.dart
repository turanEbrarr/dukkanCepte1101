...
class odeme_cari extends StatefulWidget {
  odeme_cari({super.key, required this.tahsilatId, required this.belgeTipi});
  final int? tahsilatId;
  final String? belgeTipi;

  @override
  State<odeme_cari> createState() => _odeme_cariState();
}

class _odeme_cariState extends State<odeme_cari> {
  var uuid = Uuid();
