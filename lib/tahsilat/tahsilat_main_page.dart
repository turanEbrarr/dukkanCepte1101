...
import 'package:dukkan_cepte/tahsilat/tahsilat_cari_page.dart';
import 'package:dukkan_cepte/tahsilat/tahsilat_tab_page.dart';
import 'package:dukkan_cepte/tahsilatOdemeModel/tahsilat.dart';
...
class tahsilat_main_page extends StatefulWidget {
  const tahsilat_main_page({super.key, required this.widgetListBelgeSira});
  final int widgetListBelgeSira;

  @override
  State<tahsilat_main_page> createState() => _tahsilat_main_pageState();
}

class _tahsilat_main_pageState extends State<tahsilat_main_page> {
                                                                    ...
                                                                    builder:
                                                                      ...
                                                                      return CustomAlertDialog(
                                                                        ...
                                                                        title:
                                                                            'Kayıt Başarılı',
                                                                        message:
                                                                            'Tahsilat Kaydedildi. PDF Dosyasını Görüntülemek İster misiniz?',
                                                                        onPres:
                                                                            () async {
                                                                          Navigator.pop(
                                                                              context);
                                                                  ...
                                                                  builder:
                                                                    ...
                                                                    return LoadingSpinner(
                                                                      color: Colors
                                                                          .black,
                                                                      message:
                                                                          "Online Aktarım Aktif. Tahsilat Merkeze Gönderiliyor..",
                                                                    );
                                                                  },
                                                                );
                                                                await tahsilatEx
                                                                      ...
                                                                      builder:
                                                                        ...
                                                                        return CustomAlertDialog(
                                                                          ...
                                                                          title:
                                                                              'Başarılı',
                                                                          message:
                                                                              'Tahsilat merkeze başarıyla gönderildi. PDF dosyasını görmek ister misiniz ?',
                                                                          onPres:
                                                                              () async {
                                                                            Navigator.pop(context);
                                                                  ...
                                                                  builder:
                                                                    ...
                                                                    return CustomAlertDialog(
                                                                      ...
                                                                      title:
                                                                          'Hata',
                                                                      message:
                                                                          'Tahsilatın Kalem Listesi Boş Olamaz',
                                                                      onPres:
                                                                          () async {
                                                                        Navigator.pop(
                                                                            context);
