...
import 'package:dukkan_cepte/localDB/veritabaniIslemleri.dart';
import 'package:dukkan_cepte/stok_kart/pdfOnizleme.dart';
import 'package:dukkan_cepte/stok_kart/resim.dart';
import 'package:dukkan_cepte/stok_kart/stok_kart_detay_guncel.dart';
import 'package:dukkan_cepte/stok_kart/stok_kart_ekle.dart';
...
class stokEtiket extends StatefulWidget {
  stokEtiket({super.key, required this.widgetListBelgeSira});
  final int widgetListBelgeSira;

  @override
  State<stokEtiket> createState() => _stokEtiketState();
}
...
List<barkodlar> barkodlarList=[
  ...
  List<String> yazdirilacakStokKodlari = [];
        ...
        floatingActionButton: SpeedDial(
          ...
          children: [
            ...
            SpeedDialChild(
                ...
                onTap: () async {
                  yazdirilacakStokKodlari.clear();
                  stokKartEx.tempList
                      .where((element) => true)
                      .forEach((element) {
                    element.etiketIcin = false;
                  });
                  setState(() {});
                }),
            SpeedDialChild(
                              ...
                              child: Column(
                                children: [
                                  Row(
                                    children: [
                                      Checkbox(
                                        value: stokKart.etiketIcin,
                                        onChanged: (value) {
                                          setState(() {
                                            stokKart.etiketIcin = value!;
                                            if (value == true) {
                                              yazdirilacakStokKodlari
                                                  .add(stokKart.KOD!);
                                            } else {
                                              if (yazdirilacakStokKodlari
                                                  .contains(stokKart.KOD)) {
                                                yazdirilacakStokKodlari
                                                    .remove(stokKart.KOD!);
                                              }
                                            }
                                          });
                                          print(yazdirilacakStokKodlari);
                                        },
                                      ),
                                      Expanded(
                                        child: ListTile(
                    ...
                    child: SizedBox(
                      ...
                      child: DropdownButtonHideUnderline(
                        child: DropdownButton<String>(
                          value: seciliDizayn,
                          items: dizaynlar.map((String banka) {
                    ...
                    child: SizedBox(
                      ...
                      child: DropdownButtonHideUnderline(
                        ...
                        child: DropdownButton<barkodlar>(
                          ...
                          onChanged: (barkodlar? selected) {
                            setState(() {
                              seciliBarkod = selected!;
                            });
                          },
                        ),
                      ),
                  ...
                  child: SizedBox(
                    ...
                    child: ElevatedButton(
                        ...
                        onPressed: () async {
                          ...
                          String kodlar = "";
                          for (int i = 0;
                              i < yazdirilacakStokKodlari.length;
                              i++) {
                            kodlar += "'" + yazdirilacakStokKodlari[i] + "',";
                          }
                          if (!kodlar.isEmpty) {
                            kodlar = kodlar.substring(0, kodlar.length - 1);
                          }
                          var donen = await bs.getirEtiketPdf(
                              kodlar: kodlar,
                              dizaynAdi: seciliDizayn,
                              sirket: Ctanim.sirket!,
                              sira: seciliBarkod.sira!);
                          if (donen[0] == true) {
                            Navigator.pop(context);
                            hataGosterEtiket(
                                context1: context, mesaj: donen[1]);
                          } else {
                            Uint8List bytes = base64Decode(donen[1]);
                            Navigator.pop(context);
                            Navigator.push(
                                context,
                                MaterialPageRoute(
                                    builder: (context) =>
                                        stokKartPdfOnizleme(pdfData: bytes)));
                          }
                        }),
                  ),
                )
